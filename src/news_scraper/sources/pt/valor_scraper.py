...
class ValorScraper(BaseScraper):
    ...
    MIN_SUCCESS_RATE = 0.3  # 30% - tem paywall
    HAS_PAYWALL = True
    
    def __init__(self, scraper):
        """Inicializa o scraper."""
        super().__init__(scraper, source_id="valor")
    ...
    def _collect_urls(
        ...
        Args:
            category: Categoria específica (financas, empresas, mercados, mundo, politica, brasil)
